...
std::vector<uint32_t> generateGridIndex(int gridSize) {
...
// Initialize indices
std::vector<uint32_t> indices{ generateGridIndex(GRIDSIZE) };
...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("C:/Users/Quinn/Projects/vkOceanWaves/OceanWaves/shaders/vert.spv");
        auto fragShaderCode = readFile("C:/Users/Quinn/Projects/vkOceanWaves/OceanWaves/shaders/frag.spv");
    ...
    void createComputePipeline() {
        auto computeShaderCode = readFile("C:/Users/Quinn/Projects/vkOceanWaves/OceanWaves/shaders/comp.spv");
    ...
    void createTextureSampler() {
        ...
        samplerInfo.anisotropyEnable = VK_TRUE; // Set VK_FALSE to ignore anisotropy
        samplerInfo.maxAnisotropy = properties.limits.maxSamplerAnisotropy; // then set maxAnisotropy = 1.0f
    ...
    */
    ...
    void createDescriptorSets() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            storageBufferInfoLastFrame.range = sizeof(Vertex) * VERTEX_COUNT;
            ...
            storageBufferInfoCurrentFrame.range = sizeof(Vertex) * VERTEX_COUNT;
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        // Specifying viewport and scissor states now because we made them dynamic within the pipeline
        VkViewport viewport{};
        viewport.x = 0.0f;
        viewport.y = 0.0f;
    ...
    void recordComputeCommandBuffer(VkCommandBuffer commandBuffer) {
        ...
        vkCmdDispatch(commandBuffer, VERTEX_COUNT / 256, 1, 1);
    ...
    void drawFrame() {
        ...
        // Fence is only reset if we submit work
